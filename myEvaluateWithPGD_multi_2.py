...
if __name__ == "__main__":
    ...
    parser.add_argument("--tag", default='1030_1_dice_test1', help="position of the output dir")
    ...
    folders = ["IMA_5_DSH2301Z","IMA_5_DSH230Mean","IMA_5_DSH2301Zd20","IMA_5_DSH5002Z","PGD_1_500","PGD_3_500","PGD_5_500"]
    ...
    for i, folder in enumerate(folders):
        ...
        for noise in noises: 
            ...
            MRE, SDR4 = tester.test(net, noise = noise)
