...
class Tester(object):
    ...
    def getThresholds(self, net=None):
        ...
        ax[0].hist(rList, color=cols[0], label="distribution of ratio")
        ax[1].hist(ryList, color=cols[1], label="distribution of offset y error")
        ax[2].hist(rxList, color=cols[2], label="distribution of offset x error")
        ax[0].legend()
        ax[1].legend()
        ax[2].legend() 
...
if __name__ == "__main__":
    ...
    checkpoints = torch.load("\run\model_epoch_{}.pth".format(iteration))
