...
if __name__ == "__main__":
    ...
    parser.add_argument("--tag", default='base_dice_0.5_500', help="name of the run")
    parser.add_argument("--config_file", default="config.yaml", help="default configs")
    parser.add_argument("--iteration",default = "500")
    ...
    for epoch in range(iterations):
        ...
        for img, mask, guassian_mask, offset_y, offset_x, landmark_list in tqdm(dataloader):
            ...
            loss =  regression_loss_x + regression_loss_y + logic_loss * 0.5
